...
const feature2 = "https://images.unsplash.com/photo-1630091003936-aea522c1e8c3?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
const feature1 = "https://images.unsplash.com/photo-1763972456511-fc3cf9bdca83?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw5fHx8ZW58MHx8fHx8"
const feature3 = "https://images.unsplash.com/photo-1764082497081-a023b72c9239?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxN3x8fGVufDB8fHx8fA%3D%3D"
const feature4 = "https://images.unsplash.com/photo-1764893215559-9de481fca0f5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwzMXx8fGVufDB8fHx8fA%3D%3D"
    ...
    <section className="px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              ...
              return (
                <Reveal delay={feature.id * 0.1} key={feature.id}>
                  <div
                    ...
                    className={`
                      relative p-8 cursor-pointer transition-all duration-500 ease-out border
                      ${isActive
                  ...
                  >
                    <div className="flex gap-6 items-start relative z-10">
                      ...
                      <div className="flex flex-col gap-3">
                        <h3
                          className={`text-2xl font-semibold transition-colors duration-500 ${isActive ? 'text-white' : 'text-text-main'}`}
                        >
                          {feature.title}
                        </h3>
                        ...
                        <p
                          className={`text-lg leading-relaxed transition-colors duration-500 ${isActive ? 'text-gray-400' : 'text-gray-500'}`}
                        >
                          {feature.description}
                        </p>
                      </div>
          ...
          <div className="lg:sticky lg:top-32 h-[725px] w-full overflow-hidden bg-bg-card border border-gray-100 shadow-lg relative">
            <AnimatePresence mode="wait">
              ...
              >
                 {/* Replace this div with: <img src={features[activeIndex].image} className="w-full h-full object-cover" /> */}
