...
const roles = [
  ...
  },
  {
    ...
    description:
      "Industry-level experts translating domain workflows, regulatory constraints, and legacy operations into practical, scalable AI systems."
  },
  {
  ...
  },
  {
    ...
    description:
      "Applying advanced analytics, machine learning, and statistical modeling to transform enterprise data into decision intelligence."
  },
  {
    title: "UI / UX Specialists",
    description:
      "Designing human-centric interfaces for enterprise AI and human-in-the-loop systems that drive trust, adoption, and productivity."
  }
];
