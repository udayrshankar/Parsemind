            ...
            <div className="relative z-10 p-6 md:p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg md:text-xl text-gray-600 font-inter leading-relaxed mb-8 md:mb-10">
                  Turning fragmented financial, vendor, and operational data across legacy systems
                  into a unified, AI-driven operating system that enabled scale without operational chaos.
                </p>

                {/* Metrics */}
                <div className="grid grid-cols-2 gap-6 md:gap-10 mb-8 md:mb-12 border-t border-gray-200/60 pt-8">
                  <div>
                    <div className="text-4xl md:text-5xl font-fraunces font-medium text-text-main mb-2">
                      16%
                    </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-inter font-bold text-sm text-text-main">
                      Enterprise Operations Team
                    </p>
                    <p className="font-inter text-xs font-medium text-gray-500 uppercase tracking-wide">
              ...
              <div className="order-1 lg:order-2 w-full flex justify-center lg:justify-end">
                <div className="relative w-full aspect-video lg:aspect-square max-w-lg overflow-hidden shadow-2xl border border-white/50 group">
                  <img
                    src={imageUrl}
                    alt="Enterprise AI Data Architecture Case Study"
