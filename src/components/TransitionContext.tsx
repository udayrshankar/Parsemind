    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2 className="text-6xl md:text-6xl font-bold leading-tight tracking-tighter text-transparent bg-clip-text bg-linear-to-r from-white to-gray-500 font-sans pb-10">
            AI Agentic B2B SAAS
          </h2>
        </motion.div>
      </motion.div>
